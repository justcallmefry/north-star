            ...
            >
              {loading ? (
                <span className="inline-flex items-center gap-2">
                  <span className="h-4 w-4 rounded-full border-2 border-white border-t-transparent animate-loading-spin motion-reduce:animate-none" />
                  Next…
                </span>
              ) : (
                "Next"
          ...
          <div className="mb-6">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="ns-auth-divider-label rounded-md">or use email</span>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="space-y-5">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1.5 text-slate-400 hover:bg-emerald-50 hover:text-slate-600 focus:outline-none focus:ring-2 focus:ring-brand-200"
