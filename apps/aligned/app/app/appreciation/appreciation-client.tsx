      ...
      <div className="animate-calm-fade-in space-y-6">
        <div className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-brand-600">
            {status.fromName ?? "Your partner"} noticed something about you
          </p>
        </div>
        <div className="rounded-2xl border border-brand-100 bg-gradient-to-br from-brand-50 to-white px-6 py-8 text-center shadow-sm">
          {status.fromImage && (
            <img
          ...
          <p className="text-2xl leading-relaxed text-slate-900 sm:text-3xl">
            {status.content}
          </p>
        </div>
        <p className="text-center text-sm text-slate-500">
          New appreciation available next week.
        </p>
      </div>
    );
  }
