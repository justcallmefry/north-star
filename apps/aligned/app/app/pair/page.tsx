      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="mt-2 text-slate-600">
            Share a link or code—or enter theirs. When you&apos;re paired, you&apos;ll see the same daily prompt, and
            answers only open once you&apos;ve both replied.
          </p>
          <p className="mt-3 text-xs leading-relaxed text-slate-500">
            <Link href="/app" className="font-medium text-brand-700 underline-offset-2 hover:underline">
              Not ready?
            </Link>{" "}
            You can look around—today&apos;s shared prompt stays closed until you pair.
          </p>
        </div>
