...
const DAILY_PROMPTS: Array<{
  ...
  {
    text: "What's something you're curious about right now — about life, yourself, or your connection?",
    category: "growth",
    tone: "light",
  },
  ...
  {
    text: "What's one sentence about how you're really doing that you'd want the other person to hear?",
  ...
  { text: "What's something you're looking forward to sharing with them?", category: "communication", tone: "light" },
];
...
async function main() {
  ...
  console.log(`Seeding ${DAILY_PROMPTS.length} daily prompts (parent-teen: positive, archival)...`);
